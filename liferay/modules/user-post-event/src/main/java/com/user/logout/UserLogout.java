...
public class UserLogout implements LifecycleAction {

	private static Log log = LogFactoryUtil.getLog(UserLogout.class);
	...
	public void processLifecycleEvent(LifecycleEvent lifecycleEvent) throws ActionException {
		log.info("Logout Post Action is Started");
		try {
			log.info("Post Login Action is Started");
	...
	public String getObjectDefinationName() {
		Locale locale = LocaleUtil.fromLanguageId(EventConstant.ACTIVITY);
		...
		for (ObjectDefinition objectDefinition : objectDefinitions) {
			if (objectDefinition.getLabel(locale).equals(EventConstant.ACTIVITY)) {
