package com.employee.rest.dto.v1_0;
 ...
 */
@Generated("")
@GraphQLName("EmployeeDetailObject")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "EmployeeDetailObject")
public class EmployeeDetailObject implements Serializable {

	public static EmployeeDetailObject toDTO(String json) {
		return ObjectMapperUtil.readValue(EmployeeDetailObject.class, json);
	}

	public static EmployeeDetailObject unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			EmployeeDetailObject.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.employee.rest.dto.v1_0.EmployeeDetailObject",
		name = "x-class-name"
	)
