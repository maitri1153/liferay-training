 ...
 * <code>com.employee.service.service.impl.EmployeeDetailLocalServiceImpl</code> and
...
public class EmployeeDetailLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.employee.service.service.impl.EmployeeDetailLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EmployeeDetail addEmployeeDetail(
	 ...
	 */
	public static EmployeeDetail createEmployeeDetail(long employeeId) {
	 ...
	 */
	public static EmployeeDetail deleteEmployeeDetail(
		EmployeeDetail employeeDetail) {
	 ...
	 */
	public static EmployeeDetail deleteEmployeeDetail(long employeeId)
		throws PortalException {
	...
	public static EmployeeDetail fetchEmployeeDetail(long employeeId) {
	 ...
	 */
	public static EmployeeDetail fetchEmployeeDetailByUuidAndGroupId(
	 ...
	 * @throws PortalException if a employee detail with the primary key could not be found
	 */
	public static EmployeeDetail getEmployeeDetail(long employeeId)
		throws PortalException {
	 ...
	 */
	public static EmployeeDetail getEmployeeDetailByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {
	 ...
	 */
	public static List<EmployeeDetail> getEmployeeDetails(int start, int end) {
	 ...
	 */
	public static List<EmployeeDetail> getEmployeeDetailsByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getEmployeeDetailsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static EmployeeDetail updateEmployeeDetail(
		EmployeeDetail employeeDetail) {
	...
	private static final Snapshot<EmployeeDetailLocalService> _serviceSnapshot =
		new Snapshot<>(
			EmployeeDetailLocalServiceUtil.class,
			EmployeeDetailLocalService.class);
