...
<div class="employeeList">
	...
	<liferay-ui:search-container 
		...
		<liferay-ui:search-container-row
			...
			<liferay-ui:search-container-column-text name="Employee ID" value="${employee.employeeId}" />
			
			<liferay-ui:search-container-column-text name="Name" value="${employee.firstName} ${employee.lastName}" />
			
			<liferay-ui:search-container-column-text name="Designation" value="${employee.designation}" />
			
			<liferay-ui:search-container-column-text name="Phone" value="${employee.phoneNumber}" />
			
			<liferay-ui:search-container-column-text name="Email" value="${employee.email}" />
			
			<liferay-ui:search-container-column-text name="City" value="${employee.city}" />
